                        ...
                        <div class="flex flex-col w-full max-w-2xl max-h-full bg-white rounded-lg" x-on:click.outside="selected_item_id = null">
                            ...
                            <div class="p-4 bg-gray-100 rounded-t-lg">
                                ...
                                <div class="flex items-center justify-between gap-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm mt-0.5 whitespace-pre-wrap" x-show="selectedItem.notes" x-cloak x-text="selectedItem.notes"></div>
                                    </div>
                            ...
                            <div class="p-4 bg-gray-100 rounded-b-lg">
                                <div class="flex items-stretch justify-start h-10 gap-6">
                                    ...
                                    <x-secondary-button type="button" class="flex justify-center w-10" :noSidePadding="true" x-on:click="editSelectedItem(true)" x-bind:disabled="saving">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            ...
                            <div x-show="selected_item_id && selectedItem && editing_selected_item" x-cloak x-transition.opacity class="fixed inset-0 z-20 flex items-center justify-center w-screen p-2 bg-gray-900/50">
                                <template x-if="selected_item_id && selectedItem && editing_selected_item">
                                    <form class="flex flex-col w-full max-w-xl max-h-full bg-white rounded-lg" x-on:click.outside="editSelectedItem(false)" x-on:submit.prevent="updateSelectedItem">
                                        ...
                                        <div class="p-4 bg-gray-100 rounded-t-lg">
                                            <div class="flex items-center justify-between h-10 gap-2">
                                                ...
                                                <div class="text-lg">
                                                    Edit
                                                    <span class="ml-2 font-semibold text-green-800" x-text="selectedItem.name"></span>
                                                </div>
                                                
                                                <button type="button" class="flex items-center justify-center size-10" x-on:click="editSelectedItem(false)" x-bind:disabled="saving">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
                                                    </svg>
                                                </button>
                                        ...
                                        <div class="p-4 overflow-y-auto">
                                            ...
                                            <div class="">
                                                <x-input-label for="new_selected_item_name" value="Name" />
                                                <x-text-input id="new_selected_item_name" class="block w-full pr-12 mt-1" type="text" name="new_selected_item_name" x-model="new_selected_item_name" />
                                            </div>
                                            
                                            <div class="mt-4">
                                                <x-input-label for="new_selected_item_notes" value="Notes" />
                                                <textarea x-data x-autosize x-model="new_selected_item_notes" class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500"></textarea>
                                            </div>
                                        ...
                                        <div class="p-4 bg-gray-100 rounded-b-lg">
                                            <div class="flex items-stretch justify-between h-10 gap-6">
                                                ...
                                                <x-primary-button type="submit" class="flex justify-center w-10 ml-auto" :noSidePadding="true" x-bind:disabled="saving || !new_selected_item_name.trim()">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
